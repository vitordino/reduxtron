		...
		<NavigationMenu.Item>
			<NavigationMenu.Link asChild>
				<Link
					...
					className='group flex items-center justify-between rounded hover:bg-slate-1 hover:bg-opacity-30 data-[current=true]:bg-slate-1 data-[current=true]:bg-opacity-50 hover:data-[current=true]:bg-opacity-60'
					{...keyboardLogoHandler}
				>
		...
		<NavigationMenu.Item className='lg:px-4'>
			<NavigationMenu.Link asChild {...KEYBOARD_HANDLERS[position]}>
				<Link
					...
					className='relative group lg:w-full mt-0.5 py-2 px-2 h-7 flex items-center justify-center lg:justify-normal lg:rounded cursor-pointer hover:bg-slate-1 hover:bg-opacity-30 data-[current=true]:bg-slate-1 data-[current=true]:bg-opacity-50 hover:data-[current=true]:bg-opacity-60'
				>
